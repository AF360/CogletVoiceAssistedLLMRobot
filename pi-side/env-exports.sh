...
export FACE_TRACKING_INVOKE_TIMEOUT_S="0.25"
export FACE_TRACKING_UPDATE_INTERVAL_S="0.02"
...
export FACE_TRACKING_WHEEL_LEFT_INVERT="0"
...
export FACE_TRACKING_WHEEL_RIGHT_INVERT="0"
