...
class FaceTrackingConfig:
    ...
    patrol_interval_s: float = 30.0
    patrol_range_wheels_deg: float = 40.0
    patrol_range_eyes_deg: float = 25.0
    patrol_range_pitch_deg: float = 15.0
